Pod::Spec.new do |s|
  ...
  # git remote add origin https://github.com/daicatrungisme1/YTLiveStreaming.git
  ...
  s.homepage     = "https://github.com/daicatrungisme1/YTLiveStreaming.git"

  s.source       = { :git => "https://github.com/daicatrungisme1/YTLiveStreaming.git", :tag => s.version.to_s }
